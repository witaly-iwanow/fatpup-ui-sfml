...
void umaxSetInitial()
{
    M=136,S=128,I=8e3,Q=0,O=0,K=0,N=0,R=0,J=0,Z=0,k=16;
    memset(A, 0, sizeof(A));
    memset(b, 0, sizeof(b));
    memset(T, 0, sizeof(T));
    static const char oInit[] = {-16,-15,-17,0,1,16,0,1,16,15,17,0,14,18,31,33,0,
        7,-1,11,6,8,3,6,
        6,3,5,7,4,5,3,6};
    memcpy(o, oInit, sizeof(oInit));
...
void umaxMakeMove(const char* m)
{
    N=0;
    K=*m-16*m[1]+799,L=m[2]-16*m[3]+799;               /* parse entered move */
    D(-I,I,Q,O,1,3);                                   /* think or check & do*/
}

void umaxGetMove(char* m)
{
    N=0;
    K=I;                                               /* invalid move       */
    D(-I,I,Q,O,1,3);                                   /* think or check & do*/
